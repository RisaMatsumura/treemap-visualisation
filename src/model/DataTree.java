...
public class DataTree
{
	...
	private static Parent buildTree(File rootFile, int depth)
	{
		...
		for (int i = 0; i < rootFile.listFiles().length; i++)
		{
			if (rootFile.listFiles()[i].isFile())
			{
				...
				parent.addContents(new Leaf(rootFile.listFiles()[i].getName(),
	...
	/**
	 * Returns an instance of the data tree
	 * 
	 * @param rootFile
	 * @return an instance of this DataTree
	 */
